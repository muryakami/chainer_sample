...
plt.savefig("./pic/MLP_mnist/Learning loop.png")
...
plt.savefig("./pic/MLP_mnist/Show Predict Result.png")
...
plt.savefig("./pic/MLP_mnist/layer1.png")
...
plt.savefig("./pic/MLP_mnist/layer3.png")
...
plt.savefig("./pic/MLP_mnist/Draw activation functions.png")
